...
def upgrade():
    ...
    op.add_column('references', sa.Column('open_access', sa.Boolean(), nullable=False, server_default=sa.text('false')))
    ...
    op.add_column('resources', sa.Column('open_access', sa.Boolean(), nullable=False, server_default=sa.text('false')))
