...
def initialize_elasticsearch():
    ...
    doc1 = {
        ...
        "title": "test title",
        "pubmed_type": ["Journal Article", "Review"]
    }
    doc2 = {
    ...
    doc3 = {
        ...
        "title": "Book 1",
        "pubmed_type": ["Book", "Abstract", "Category1", "Category2", "Category3"]
    }
    doc4 = {
        "curie": "AGR:AGR-Reference-0000000004",
        "title": "Book 2",
        "pubmed_type": ["Book", "Category4", "Test", "category5", "Category6", "Category7"]
    }
...
class TestSearch:
    ...
    def test_search_references_return_facets_only(self, initialize_elasticsearch):
        facets_values = {
            "pubmed_type.keyword": (["Journal Article", "Review"])
        }
        res = search_references(query=None, facets_values=facets_values, return_facets_only=True)
        assert "aggregations" in res and "pubmed_type.keyword" in res["aggregations"]
        assert len(res["aggregations"]["pubmed_type.keyword"]["buckets"]) > 0
    ...
    def test_search_references_facets_limits(self, initialize_elasticsearch):
        res = search_references(return_facets_only=True, facets_limits={"pubmed_type.keyword": 15})
        assert len(res["aggregations"]["pubmed_type.keyword"]["buckets"]) > 10
