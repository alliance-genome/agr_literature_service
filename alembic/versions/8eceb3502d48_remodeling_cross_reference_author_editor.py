...
Revision ID: 8eceb3502d48
Revises: fbd067b9e403
Create Date: 2022-10-22 01:08:43.702506
...
def upgrade():
    ...
    op.execute(schema.CreateSequence(Sequence("cross_reference_id_seq")))
    op.add_column('cross_reference', sa.Column('cross_reference_id', sa.Integer(), nullable=False,
                                               server_default=sa.text("nextval('cross_reference_id_seq'::regclass)")))
    op.add_column('cross_reference', sa.Column('curie_prefix', sa.String(), nullable=True))
    op.add_column('cross_reference', sa.Column('date_created', sa.DateTime(), nullable=True))
    ...
    op.add_column('cross_reference_version', sa.Column('cross_reference_id', sa.Integer(), autoincrement=False, nullable=True))
