...
def upgrade():
    ...
    op.create_table('person_cross_reference_version',
    ...
    op.create_table('person_cross_reference',
    ...
    op.create_foreign_key(None, 'users', 'person', ['person_id'], ['person_id'], ondelete='SET NULL')
    ...
    op.add_column('users_version', sa.Column('id_mod', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    op.add_column('users_version', sa.Column('automation_username_mod', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    op.add_column('users_version', sa.Column('person_id_mod', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    op.alter_column('users_version', 'id',
               existing_type=sa.VARCHAR(),
               nullable=True,
               autoincrement=False)
    op.create_index(op.f('ix_users_version_automation_username'), 'users_version', ['automation_username'], unique=False)
