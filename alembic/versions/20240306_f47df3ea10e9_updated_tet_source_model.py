...
Revision ID: f47df3ea10e9
Revises: 7db22549130a
Create Date: 2024-03-06 21:18:56.238891
...
def upgrade():
    ...
    op.add_column('topic_entity_tag_source', sa.Column('data_provider', sa.String(), nullable=False))
    ...
    op.create_index(op.f('ix_topic_entity_tag_source_data_provider'), 'topic_entity_tag_source', ['data_provider'], unique=False)
    ...
    op.create_unique_constraint('topic_entity_tag_source_unique', 'topic_entity_tag_source', ['source_evidence_assertion', 'source_method', 'data_provider', 'secondary_data_provider_id'])
    ...
    op.add_column('topic_entity_tag_source_version', sa.Column('data_provider', sa.String(), autoincrement=False, nullable=True))
    op.add_column('topic_entity_tag_source_version', sa.Column('data_provider_mod', sa.Boolean(), server_default=sa.text('false'), nullable=False))
    ...
    op.create_index(op.f('ix_topic_entity_tag_source_version_data_provider'), 'topic_entity_tag_source_version', ['data_provider'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_topic_entity_tag_source_version_data_provider'), table_name='topic_entity_tag_source_version')
    ...
    op.drop_column('topic_entity_tag_source_version', 'data_provider_mod')
    op.drop_column('topic_entity_tag_source_version', 'data_provider')
    ...
    op.drop_index(op.f('ix_topic_entity_tag_source_data_provider'), table_name='topic_entity_tag_source')
    ...
    op.drop_column('topic_entity_tag_source', 'data_provider')
    # ### end Alembic commands ###
