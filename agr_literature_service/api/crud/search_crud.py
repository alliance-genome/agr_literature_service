...
def show_need_review(mod_abbreviation, count, db: Session):
    ...
    return show_sort_search_result(references, mod_abbreviation, db)


def show_sort_search_result(references, mod_abbreviation, db):
...
def show_sort_prepublication_pipeline(mod_abbreviation, count, db: Session):
