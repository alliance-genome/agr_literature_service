...
# TODO 1: pass in mod_abbreviation or to get this list from database
curie_prefix_list = [
    "FB",
    "MGI",
    "RGD",
...
def map_entity_to_curie(db: Session, entity_type, entity_list):
    ...
    entity_name_rows = search_for_entity_names(db, entity_type, entity_name_list)
...
def search_for_entity_names(db: Session, entity_type, entity_name_list):
