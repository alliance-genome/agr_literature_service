...
from agr_literature_service.api.crud.topic_entity_tag_utils import get_reference_id_from_curie_or_id, \
    ...
    map_curies_to_names, check_and_set_sgd_display_tag, check_and_set_species, \
...
def get_curie_to_name_from_all_tets(db: Session, curie_or_reference_id: str):
    ...
    entity_curie_to_name = map_curies_to_names(db, category="atpterm", curies=list(all_atp_terms))
    entity_curie_to_name.update(map_curies_to_names(db, category="ecoterm",
                                                    curies=list(source_eco_codes)))
    entity_curie_to_name.update(map_curies_to_names(db, category="species",
