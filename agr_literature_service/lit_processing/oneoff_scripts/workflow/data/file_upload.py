def get_data(name_to_atp):
    ...
    test_data = [
        ...
        {'mod': "NOT_WB",
         ...
         'action': [f"proceed_on_value::category::thesis::{name_to_atp['text conversion needed']}"]
         },
        {'mod': "WB",
         'from': "file upload in progress",
         'to': "files uploaded",
         'condition': 'on_success',
         'action': [f"proceed_on_value::reference_type::experimental::{name_to_atp['text conversion needed']}"]
         },
        {'mod': "ALL",
         'from': "file upload in progress",
         'to': "file unavailable",
