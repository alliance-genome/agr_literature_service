...
suppl_file_urls_file = "data/suppl_file_urls.txt"
suppl_file_downloaded = "data/suppl_files_downloaded.txt"
...
def unzip_file(file_with_path):
    ...
    try:
        with zipfile.ZipFile(file_with_path, 'r') as zip_ref:
...
def download_file_from_s3(s3_client, s3_url):
    ...
    s3_file_location = s3_file_location.replace(' ', '')
